...
export type PeopleQueryQuery = { __typename?: 'Root', allPeople?: { __typename?: 'PeopleConnection', people?: Array<{ __typename?: 'Person', name?: string | null } | null> | null } | null };
...
export function usePeopleQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PeopleQueryQuery, PeopleQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PeopleQueryQuery, PeopleQueryQueryVariables>(PeopleQueryDocument, options);
        }
export function usePeopleQuerySuspenseQuery(baseOptions?: Apollo.SuspenseQueryHookOptions<PeopleQueryQuery, PeopleQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<PeopleQueryQuery, PeopleQueryQueryVariables>(PeopleQueryDocument, options);
        }
...
export type PeopleQuerySuspenseQueryHookResult = ReturnType<typeof usePeopleQuerySuspenseQuery>;
