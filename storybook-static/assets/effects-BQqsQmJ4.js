import{j as e}from"./jsx-runtime-DBEcOq3S.js";import{useMDXComponents as o}from"./index-CA_HyBnq.js";import{ae as x,af as s}from"./index-DqyB5r8P.js";import{Documentation as d,SourceCode as l}from"./effects-DIhOIjIs.js";import"./index-DtJulBIN.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-5MdjxzLk.js";import"../sb-preview/runtime.js";import"./index-BqTDQIm7.js";import"./index-D-8MO0q_.js";import"./extends-CF3RwP-h.js";import"./_defineProperty-DSxlPr5D.js";import"./_overArg-BZNRQ6_9.js";import"./_baseAssignValue-DD5bxUnJ.js";import"./_getPrototype-By7W0WFf.js";import"./index-CFFTH5x_.js";import"./index-DrFu-skq.js";const r={boxShadow:{sm:"0 1px 2px 0 rgb(0 0 0 / 0.05)",DEFAULT:"0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)",md:"0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1)",lg:"0 10px 15px -3px rgb(0 0 0 / 0.1), 0 4px 6px -4px rgb(0 0 0 / 0.1)",xl:"0 20px 25px -5px rgb(0 0 0 / 0.1), 0 8px 10px -6px rgb(0 0 0 / 0.1)","2xl":"0 25px 50px -12px rgb(0 0 0 / 0.25)",inner:"inset 0 2px 4px 0 rgb(0 0 0 / 0.05)",none:"none"},boxShadowColor:({theme:i})=>i("colors"),opacity:{0:"0",5:"0.05",10:"0.1",15:"0.15",20:"0.2",25:"0.25",30:"0.3",35:"0.35",40:"0.4",45:"0.45",50:"0.5",55:"0.55",60:"0.6",65:"0.65",70:"0.7",75:"0.75",80:"0.8",85:"0.85",90:"0.9",95:"0.95",100:"1"}},h=`export default {\r
    boxShadow: {\r
        sm: '0 1px 2px 0 rgb(0 0 0 / 0.05)',\r
        DEFAULT: '0 1px 3px 0 rgb(0 0 0 / 0.1), 0 1px 2px -1px rgb(0 0 0 / 0.1)',\r
        ...
        '2xl': '0 25px 50px -12px rgb(0 0 0 / 0.25)',\r
        inner: 'inset 0 2px 4px 0 rgb(0 0 0 / 0.05)',\r
        none: 'none',\r
    },\r
    boxShadowColor: ({ theme }) => theme('colors'),\r
    opacity: {\r
        0: '0',\r
        5: '0.05',\r
        10: '0.1',\r
    ...
    \r
}`;function c(i){const n={a:"a",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",ul:"ul",...o(),...i.components};return e.jsxs(e.Fragment,{children:[e.jsx(x,{title:"Tailwind/Theme/Effects"}),`
...
`,e.jsx(s,{language:"js",code:`boxShadow: ${JSON.stringify(r.boxShadow,null,2)}`}),`
...
`,e.jsx(s,{language:"tsx",code:`sm: ${r.boxShadow.sm}`}),`
...
`,e.jsx(s,{language:"tsx",code:`DEFAULT: ${r.boxShadow.DEFAULT}`}),`
...
`,e.jsx(s,{language:"tsx",code:`md: ${r.boxShadow.md}`}),`
...
`,e.jsx(s,{language:"tsx",code:`lg: ${r.boxShadow.lg}`}),`
...
`,e.jsx(s,{language:"tsx",code:`xl: ${r.boxShadow.xl}`}),`
...
`,e.jsx(s,{language:"tsx",code:`'2xl': ${r.boxShadow["2xl"]}`}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"0"}),": Horizontal offset."]}),`
...
`,e.jsx(s,{language:"tsx",code:`inner: ${r.boxShadow.inner}`}),`
`,e.jsxs(n.ul,{children:[`
...
`,e.jsx(s,{language:"tsx",code:`none: ${r.boxShadow.none}`}),`
...
`,e.jsx(s,{language:"js",code:`opacity: ${JSON.stringify(r.opacity,null,2)}`}),`
`,typeof d=="function"&&d().toString()!==""&&e.jsxs(e.Fragment,{children:[e.jsx(n.h2,{children:"Extended Documentation"}),e.jsx(d,{})]}),`
`,e.jsx(n.h2,{id:"source-code",children:"Source Code"}),`
`,e.jsx(s,{language:"js",code:h}),`
`,typeof l=="function"&&l().toString()!==""&&e.jsxs(e.Fragment,{children:[e.jsx(n.h3,{children:"Extended Source Code"}),e.jsx(l,{})]})]})}function E(i={}){const{wrapper:n}={...o(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(c,{...i})}):c(i)}export{E as default};
