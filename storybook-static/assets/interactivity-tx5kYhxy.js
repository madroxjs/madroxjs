import{j as e}from"./jsx-runtime-DBEcOq3S.js";import{useMDXComponents as t}from"./index-CA_HyBnq.js";import{ae as d,af as n}from"./index-DqyB5r8P.js";import{Documentation as i,SourceCode as c}from"./interactivity-Bu6JdFBM.js";import"./index-DtJulBIN.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-5MdjxzLk.js";import"../sb-preview/runtime.js";import"./index-BqTDQIm7.js";import"./index-D-8MO0q_.js";import"./extends-CF3RwP-h.js";import"./_defineProperty-DSxlPr5D.js";import"./_overArg-BZNRQ6_9.js";import"./_baseAssignValue-DD5bxUnJ.js";import"./_getPrototype-By7W0WFf.js";import"./index-CFFTH5x_.js";import"./index-DrFu-skq.js";const o={accentColor:({theme:s})=>({...s("colors"),auto:"auto"}),caretColor:({theme:s})=>s("colors"),cursor:{auto:"auto",default:"default",pointer:"pointer",wait:"wait",text:"text",move:"move",help:"help","not-allowed":"not-allowed",none:"none","context-menu":"context-menu",progress:"progress",cell:"cell",crosshair:"crosshair","vertical-text":"vertical-text",alias:"alias",copy:"copy","no-drop":"no-drop",grab:"grab",grabbing:"grabbing","all-scroll":"all-scroll","col-resize":"col-resize","row-resize":"row-resize","n-resize":"n-resize","e-resize":"e-resize","s-resize":"s-resize","w-resize":"w-resize","ne-resize":"ne-resize","nw-resize":"nw-resize","se-resize":"se-resize","sw-resize":"sw-resize","ew-resize":"ew-resize","ns-resize":"ns-resize","nesw-resize":"nesw-resize","nwse-resize":"nwse-resize","zoom-in":"zoom-in","zoom-out":"zoom-out"},scrollMargin:({theme:s})=>({...s("spacing")}),scrollPadding:({theme:s})=>s("spacing"),willChange:{auto:"auto",scroll:"scroll-position",contents:"contents",transform:"transform"}},a=`export default {\r
    ...
    cursor: {\r
        ...
        move: 'move',\r
        help: 'help',\r
        'not-allowed': 'not-allowed',\r
        none: 'none',\r
        'context-menu': 'context-menu',\r
        progress: 'progress',\r
        cell: 'cell',\r
        crosshair: 'crosshair',\r
        'vertical-text': 'vertical-text',\r
        alias: 'alias',\r
        copy: 'copy',\r
        'no-drop': 'no-drop',\r
        grab: 'grab',\r
        grabbing: 'grabbing',\r
        'all-scroll': 'all-scroll',\r
        'col-resize': 'col-resize',\r
        'row-resize': 'row-resize',\r
        'n-resize': 'n-resize',\r
        'e-resize': 'e-resize',\r
        's-resize': 's-resize',\r
        'w-resize': 'w-resize',\r
        'ne-resize': 'ne-resize',\r
        'nw-resize': 'nw-resize',\r
        'se-resize': 'se-resize',\r
        'sw-resize': 'sw-resize',\r
        'ew-resize': 'ew-resize',\r
        'ns-resize': 'ns-resize',\r
        'nesw-resize': 'nesw-resize',\r
        'nwse-resize': 'nwse-resize',\r
        'zoom-in': 'zoom-in',\r
        'zoom-out': 'zoom-out',\r
    },\r
    ...
    scrollPadding: ({ theme }) => theme('spacing'),\r
    willChange: {\r
        auto: 'auto',\r
        scroll: 'scroll-position',\r
        contents: 'contents',\r
