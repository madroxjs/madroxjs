import{j as n}from"./jsx-runtime-DBEcOq3S.js";import{useMDXComponents as l}from"./index-CA_HyBnq.js";import{ae as c,af as e}from"./index-Dy4-7q8M.js";import{Documentation as s,SourceCode as r}from"./animation-HQoMv22l.js";import"./index-DtJulBIN.js";import"./_commonjsHelpers-BosuxZz1.js";import"./iframe-afcKKGwg.js";import"../sb-preview/runtime.js";import"./index-BqTDQIm7.js";import"./index-D-8MO0q_.js";import"./extends-CF3RwP-h.js";import"./_defineProperty-DSxlPr5D.js";import"./_overArg-BZNRQ6_9.js";import"./_baseAssignValue-DD5bxUnJ.js";import"./_getPrototype-By7W0WFf.js";import"./index-CFFTH5x_.js";import"./index-DrFu-skq.js";const d=`export default {
  animation: {
      none: 'none',
...
`,n.jsx(e,{language:"js",code:`animation: ${JSON.stringify(o.animation,null,2)}`}),`
`,n.jsx(i.h3,{id:"none",children:"None"}),`
`,n.jsx(i.p,{children:"No animation applied."}),`
`,n.jsx(e,{language:"js",code:`none: ${JSON.stringify(o.animation.none,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`spin: ${JSON.stringify(o.animation.spin,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`ping: ${JSON.stringify(o.animation.ping,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`pulse: ${JSON.stringify(o.animation.pulse,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`bounce: ${JSON.stringify(o.animation.bounce,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`keyframes: ${JSON.stringify(o.keyframes,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`transitionDelay: ${JSON.stringify(o.transitionDelay,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`transitionDuration: ${JSON.stringify(o.transitionDuration,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`trainsitionProperty: ${JSON.stringify(o.trainsitionProperty,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`transitionTimingFunction: ${JSON.stringify(o.transitionTimingFunction,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`DEFAULT: ${JSON.stringify(o.transitionTimingFunction.DEFAULT,null,2)}`}),`
...
`,n.jsx(e,{language:"js",code:`linear: ${JSON.stringify(o.transitionTimingFunction.linear,null,2)}`}),`
`,n.jsxs(i.ul,{children:[`
...
`,n.jsx(e,{language:"js",code:`in: ${JSON.stringify(o.transitionTimingFunction.in,null,2)}`}),`
`,n.jsxs(i.ul,{children:[`
`,n.jsxs(i.li,{children:[n.jsx(i.strong,{children:"0.4, 0"}),": Controls the initial portion of the transition, making it start slowly."]}),`
...
`,n.jsx(e,{language:"js",code:`out: ${JSON.stringify(o.transitionTimingFunction.out,null,2)}`}),`
`,n.jsxs(i.ul,{children:[`
...
`,n.jsx(e,{language:"js",code:`'in-out': ${JSON.stringify(o.transitionTimingFunction["in-out"],null,2)}`}),`
`,n.jsxs(i.ul,{children:[`
`,n.jsxs(i.li,{children:[n.jsx(i.strong,{children:"0.4, 0"}),": Controls the initial portion of the transition, making it start slowly."]}),`
`,n.jsxs(i.li,{children:[n.jsx(i.strong,{children:"0.2, 1"}),": Controls the end portion of the transition, making it slow down towards the end."]}),`
`]}),`
