...
└── components
    ...
    ├── Templates/
    ├── Pages/
    └── index.ts`})]})}function M(t={}){const{wrapper:n}={...s(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{M as default};
